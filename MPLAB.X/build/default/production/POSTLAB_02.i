...
# 10 "./USART_Library.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c90\\stdint.h" 1 3
# 11 "./USART_Library.h" 2
# 21 "./USART_Library.h"
...
char LcdALLb_set_value(int byte_value);
...
void __attribute__((picinterrupt(("")))) isr(void){
    ...
    if(RCIF == 1){
        PORTD = RCREG;
        if (RCREG == 48){
        UART_write_string("Voltaje Potenciometro:");
        UART_set_value(mapeado);
        }
        cont = UART_read_char();
        PIR1bits.RCIF = 0;
    }
...
void main(void) {
  ...
  while(1)
  {
    ...
    LcdALL_Write_String("Pot1:  CPU:");
    LcdALL_Set_Cursor(2,1);
    mapeado = LcdALL_map(ADRESH, 0, 255, 0, 500);
    LcdALL_set_value(mapeado);
    LcdALL_Write_String("   ");
    LcdALLb_set_value(cont);
