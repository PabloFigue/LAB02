...
# 10 "FourDISP_Library.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c90\\stdint.h" 1 3
# 11 "FourDISP_Library.c" 2
...
void set_value(int byte_value){
    ...
    centenas = ((byte_value / 100)%10);
    decenas = ((byte_value/10)%10);
    unidades = (byte_value%10);
}
